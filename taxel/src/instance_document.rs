use crate::ebilanz::{BASELINE_ROLE_URIS, REPORT_ELEMENT_TO_ROLE_URI, REQUIRED_NIL_TUPLE_CHILDREN};
use anyhow::Context;
use chrono::NaiveDate;
use log::debug;
use std::collections::{HashMap, HashSet};
use xbrl_rs::{
    Concept, Context as XbrlContext, ContextId, ElementParticle, EntityIdentifier, ExpandedName,
    Fact, GroupParticle, InstanceDocument, ItemFact, NamespacePrefix, NamespaceUri, Particle,
