...
pub use crate::{
    ...
    ebilanz::{
        TaxonomyType, CLOSING_DATE, COMPANY_CITY, COMPANY_COUNTRY, COMPANY_HOUSE_NO, COMPANY_NAME,
        COMPANY_STREET, COMPANY_TAX_NUMBER, COMPANY_TAX_NUMBER_PARENT, COMPANY_ZIP_CODE,
        FISCAL_YEAR_BEGIN, FISCAL_YEAR_END, GCD_LABEL, GCD_ROLE_URI, REPORT_ELEMENT_TO_ROLE_URI,
        REQUIRED_GCD_FACTS, ROLE_URI_TO_REPORT_ELEMENT, TAXONOMY_DATE_TO_VERSION, TAXONOMY_TYPES,
